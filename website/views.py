...
from .models import Post, User, Comment, Like, Category, Tag
from . import db
...
def create_post():
    ...
    if request.method == "POST":
        ...
        if not text:
            ...
            post = Post(text=text, author=current_user.id, category_id=category_id if category_id else None)
            db.session.add(post)
            db.session.commit()
...
def delete_post(id):
    ...
    elif current_user.id != post.author:  # <-- compare to author ID directly
